...
$(function(){
	$("#btn").click(function(){
		//HTML Form Control의 값을 전달하려면 <form>의 submit() 호출
		$("#frmGet").submit();
	});
...
<tr>
<td colspan="2">
	<input type="button" value="값 전송" class="btn btn-info btn-sm" id="btn"/>
</td>
</tr>
...
<tr>
<td colspan="2">
	<input type="button" value="POST 값 전송" class="btn btn-warning btn-sm" id="btnPost"/>
</td>
</tr>
