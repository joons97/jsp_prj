...
<table>
	...
	<tr>
		...
		<td><input type="text" name="name" id="name" class="inputBox" style="width: 200px" value="테스트"></td>
	</tr>
	
	<tr>
		<td><span class="required">*</span>생일</td>
		<td><input type="text" name="birth" id="birth" class="inputBox" maxlength="10" style="width: 150px"  value="1999-01-01"></td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" name="addr1" id="addr1" readonly="readonly" class="inputBox" style="width: 500px; margin-bottom: 3px"  value="경기 성남시 분당구 대왕판교로 477"> <br> 
